...
namespace ServiceRest_20190140022_LaelaWulidaImroatusSolikha
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data source=LAPTOP-UDM5IM68;Initial catalog=\"TI UMY\";Persist security Info=True;user ID=sa;Password=laela278");
